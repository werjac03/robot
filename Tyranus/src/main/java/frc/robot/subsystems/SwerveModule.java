...
public class SwerveModule {
   ...
   */
  public SwerveModule(int driveMotorChannel, int turningMotorChannel, int encoderPort, boolean turningEncoderReversed) {
    ...
    m_absoluteEncoder = new AbsoluteEncoder(encoderPort, ModuleConstants.angleOffset);
